...
from models.Network_G import Gendef
from models.RDAB_base import RDABBase
from models.loss_ssim import SSIMLoss

from utils.utils_main import test_mode, regularizer_orth, regularizer_clip


class RDABModel(RDABBase):
    def __init__(self, opt):
        super(RDABModel, self).__init__(opt)
        # ------------------------------------
        # define network
        # ------------------------------------
        self.netG = Gendef(opt).to(self.device)
